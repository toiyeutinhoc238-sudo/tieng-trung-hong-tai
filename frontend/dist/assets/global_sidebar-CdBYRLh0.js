(function(){const m=document.createElement("link").relList;if(m&&m.supports&&m.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))h(t);new MutationObserver(t=>{for(const l of t)if(l.type==="childList")for(const b of l.addedNodes)b.tagName==="LINK"&&b.rel==="modulepreload"&&h(b)}).observe(document,{childList:!0,subtree:!0});function u(t){const l={};return t.integrity&&(l.integrity=t.integrity),t.referrerPolicy&&(l.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?l.credentials="include":t.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function h(t){if(t.ep)return;t.ep=!0;const l=u(t);fetch(t.href,l)}})();(function(){function k(){const e=window.location.pathname.toLowerCase(),i=window.location.search.toLowerCase();return e==="/"||e.endsWith("/index.html")?i.includes("tab=flashcards")?"flashcards":i.includes("view=roadmap")||window.location.hash.includes("roadmap")?"roadmap":"home":e.includes("video-dictation")?i.includes("mode=shadowing")?"shadowing":"dictation":e.includes("reading-practice")?"reading":e.includes("chinese-phonetics")?"phonetics":e.includes("chinese-radicals")?"radicals":e.includes("hanzi-writer")?"hanzi":e.includes("hsk-grammar")?"grammar":e.includes("lesson-texts")?"texts":e.includes("detail-list")?"vocabulary":e.includes("quiz-game")?"games":e.includes("han-viet-rules")?"rules":e.includes("rank")?"rank":""}function m(){try{const e=localStorage.getItem("user")||localStorage.getItem("hongtai_current_user")||localStorage.getItem("currentUser")||sessionStorage.getItem("user");if(e)return JSON.parse(e)}catch{}return null}function u(){const e=m();document.querySelectorAll(".app-sidebar, .global-app-sidebar").forEach(o=>{const s=o.querySelector(".user-name, #user-display-name"),r=o.querySelector(".user-sub, #user-display-email"),a=o.querySelector(".user-role-badge, #user-display-role"),c=o.querySelector(".sidebar-avatar-wrap"),d=o.querySelector(".sidebar-auth-action-item");if(e&&(e.name||e.email)){const w=e.name||e.displayName||(e.email?e.email.split("@")[0]:"Học viên"),y=e.email||"",v=e.role==="super_admin"?"Super Admin":e.role==="admin"?"Admin":e.role==="teacher"?"Giáo viên":"Học viên",g=e.picture||e.avatar||"";s&&(s.textContent=w),r&&(r.textContent=y),a&&(a.textContent=v),c&&(g?c.innerHTML=`<img class="user-avatar-img" src="${g}" alt="Avatar" style="display: block; width: 44px; height: 44px; border-radius: 50%; object-fit: cover;">`:c.innerHTML='<div class="user-avatar sidebar-avatar-placeholder"><i class="fa-solid fa-user"></i></div>'),d&&(d.innerHTML=`
          ...
          `)}else s&&(s.textContent="Khách (Chưa đăng nhập)"),r&&(r.textContent="Đăng nhập để lưu tiến độ học"),a&&(a.textContent="Khách"),c&&(c.innerHTML='<div class="user-avatar sidebar-avatar-placeholder"><i class="fa-solid fa-user"></i></div>'),d&&(d.innerHTML=`
          ...
          `)})}function h(){const e=k(),i=m(),o=i?i.name||i.displayName||(i.email?i.email.split("@")[0]:"Học viên"):"Khách (Chưa đăng nhập)",s=i?i.email||"":"Đăng nhập để lưu tiến độ học",r=i?i.role==="super_admin"?"Super Admin":i.role==="admin"?"Admin":i.role==="teacher"?"Giáo viên":"Học viên":"Khách",a=i&&(i.picture||i.avatar)?i.picture||i.avatar:"";return`
          ...
          <div class="user-profile sidebar-profile-card" onclick="window.toggleGlobalUserDropdown && window.toggleGlobalUserDropdown(event)"
            ...
            <div style="display: flex; align-items: center; gap: 10px; min-width: 0; flex: 1;">
              ...
              <div class="user-info" style="min-width: 0; flex: 1; display: flex; flex-direction: column; overflow: hidden;">
                <span class="user-name" style="font-weight: 700; font-size: 0.92rem; color: #fff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${o}</span>
                <span class="user-sub" style="font-size: 0.72rem; color: #94a3b8; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${s}</span>
    ...
    `}window.openGlobalSidebar=function(){u();const e=window.location.pathname==="/"||window.location.pathname.endsWith("/index.html");if(e&&window.innerWidth>900){document.body.classList.remove("sidebar-collapsed"),localStorage.setItem("sidebar_collapsed","false");return}const i=document.querySelector(".app-sidebar")||document.getElementById("global-app-sidebar"),o=document.querySelector(".sidebar-backdrop")||document.getElementById("global-sidebar-backdrop");i&&(i.classList.add("open","active"),i.style.pointerEvents="auto"),o&&(!e||window.innerWidth<=900)&&o.classList.add("active"),document.body.classList.add("sidebar-open")},window.closeGlobalSidebar=function(){const e=document.querySelector(".app-sidebar")||document.getElementById("global-app-sidebar"),i=document.querySelector(".sidebar-backdrop")||document.getElementById("global-sidebar-backdrop");e&&e.classList.remove("open","active"),i&&i.classList.remove("active"),document.body.classList.remove("sidebar-open")},window.toggleGlobalSidebar=function(){if((window.location.pathname==="/"||window.location.pathname.endsWith("/index.html"))&&window.innerWidth>900){window.toggleSidebarCollapse?window.toggleSidebarCollapse():document.body.classList.toggle("sidebar-collapsed");return}const i=document.querySelector(".app-sidebar")||document.getElementById("global-app-sidebar");i&&(i.classList.contains("open")||i.classList.contains("active")||document.body.classList.contains("sidebar-open"))?window.closeGlobalSidebar():window.openGlobalSidebar()},window.toggleGlobalUserDropdown=function(e){e&&(e.stopPropagation(),typeof e.preventDefault=="function"&&e.preventDefault());const i=e&&e.target?e.target.closest(".user-dropdown"):null;i?i.classList.toggle("show-menu"):document.querySelectorAll(".user-dropdown").forEach(s=>s.classList.toggle("show-menu"))},window.toggleUserDropdown=window.toggleGlobalUserDropdown,window.handleGlobalLogout=async function(e){e&&(e.stopPropagation(),typeof e.preventDefault=="function"&&e.preventDefault());try{await fetch("/api/auth/logout",{method:"POST",credentials:"include"})}catch{}if(localStorage.removeItem("user"),localStorage.removeItem("currentUser"),localStorage.removeItem("hongtai_user"),localStorage.removeItem("hongtai_current_user"),localStorage.removeItem("session_token"),sessionStorage.removeItem("user"),typeof google<"u"&&google.accounts&&google.accounts.id)try{google.accounts.id.disableAutoSelect()}catch{}typeof window.handleLogout=="function"?window.handleLogout(e):window.location.reload()},window.openLoginPrompt=function(){const e=document.getElementById("app-login-modal")||document.getElementById("auth-required-modal");e?(e.style.display="flex",document.body.style.overflow="hidden"):window.location.href="/?login=true"},document.addEventListener("keydown",function(e){e.key==="Escape"&&(window.closeGlobalSidebar(),document.querySelectorAll(".user-dropdown.show-menu").forEach(i=>i.classList.remove("show-menu")))}),document.addEventListener("click",function(e){e.target.closest(".user-dropdown")||document.querySelectorAll(".user-dropdown.show-menu").forEach(i=>i.classList.remove("show-menu"))});function t(){const e=window.location.pathname==="/"||window.location.pathname.endsWith("/index.html");e&&window.innerWidth>=768&&(document.body.classList.remove("sidebar-collapsed"),localStorage.setItem("sidebar_collapsed","false"));let i=document.querySelector(".sidebar-backdrop");if(i?e&&i.classList.add("on-index"):(i=document.createElement("div"),i.className="sidebar-backdrop"+(e?" on-index":""),i.id="global-sidebar-backdrop",document.body.appendChild(i)),i.addEventListener("click",function(a){window.closeGlobalSidebar()}),!document.querySelector(".app-sidebar")&&!e){const a=document.createElement("div");a.id="global-sidebar-mount",a.innerHTML=h(),document.body.insertBefore(a.firstElementChild,document.body.firstChild)}u(),window.addEventListener("storage",u),window.addEventListener("user-auth-changed",u),setTimeout(u,500),setTimeout(u,1500),document.querySelectorAll(".app-sidebar, .global-app-sidebar").forEach(a=>{a.addEventListener("click",c=>{c.target.closest(".user-dropdown")||document.querySelectorAll(".user-dropdown.show-menu").forEach(d=>d.classList.remove("show-menu")),c.stopPropagation()})});const s=()=>{document.querySelectorAll(".app-sidebar .sidebar-item, .global-app-sidebar .sidebar-item, .app-sidebar .sidebar-subitem, .global-app-sidebar .sidebar-subitem").forEach(a=>{a.classList.contains("sidebar-dropdown-toggle")||(a.style.pointerEvents="auto",a.addEventListener("click",()=>{window.innerWidth<=900&&setTimeout(()=>{window.closeGlobalSidebar()},120)}))})};s(),setTimeout(s,600),l();const r=()=>{document.querySelectorAll(".menu-toggle-btn, .global-hamburger-btn, .sidebar-open-btn, .top-menu-btn, #top-sidebar-toggle-btn, #sidebar-expand-float-btn, .sidebar-expand-float-btn, #mobile-nav-toggle-btn").forEach(a=>{a.onclick=window.toggleGlobalSidebar})};r(),setTimeout(r,500)}function l(){if(document.getElementById("menu-bubble-widget"))return;const e=window.location.pathname==="/"||window.location.pathname.endsWith("/index.html"),i=document.createElement("div");i.className="menu-bubble-widget"+(e?" on-index-page":""),i.id="menu-bubble-widget";const o=document.createElement("button");o.className="menu-bubble-btn",o.id="menu-bubble-btn",o.title="Mở Menu Danh Mục (☰)",o.setAttribute("aria-label","Mở Menu Danh Mục"),o.innerHTML='<i class="fa-solid fa-bars"></i>',i.appendChild(o),document.body.appendChild(i),b(i,o)}function b(e,i){let o=!1,s=0,r=0,a=0,c=0,d=!1;function w(n){return n.touches&&n.touches.length>0?{x:n.touches[0].clientX,y:n.touches[0].clientY}:{x:n.clientX,y:n.clientY}}function y(n){if(n.button&&n.button!==0)return;const p=w(n);s=p.x,r=p.y;const f=e.getBoundingClientRect();a=f.left,c=f.top,d=!1,o=!0,e.style.transition="none"}function v(n){if(!o)return;const p=w(n),f=p.x-s,x=p.y-r;if(!d&&(Math.abs(f)>6||Math.abs(x)>6)&&(d=!0),d){n.cancelable&&n.preventDefault();const L=window.innerWidth-e.offsetWidth-10,S=window.innerHeight-e.offsetHeight-10,C=Math.max(10,Math.min(L,a+f)),M=Math.max(10,Math.min(S,c+x));e.style.left=`${C}px`,e.style.top=`${M}px`,e.style.bottom="auto",e.style.right="auto"}}function g(n){if(o)if(o=!1,e.style.transition="all 0.3s cubic-bezier(0.16, 1, 0.3, 1)",!d)window.toggleGlobalSidebar();else{const p=e.getBoundingClientRect(),f=window.innerWidth/2;p.left+p.width/2<f?(e.style.left="16px",e.style.right="auto"):(e.style.left=`${window.innerWidth-p.width-16}px`,e.style.right="auto")}}i.addEventListener("touchstart",y,{passive:!1}),window.addEventListener("touchmove",v,{passive:!1}),window.addEventListener("touchend",g),i.addEventListener("mousedown",y),window.addEventListener("mousemove",v),window.addEventListener("mouseup",g)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()})();
