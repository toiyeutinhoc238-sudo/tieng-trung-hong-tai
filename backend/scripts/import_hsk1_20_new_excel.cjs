...
const excelPath = path.join(__dirname, '../../filetuvung/Từ vựng HSK 1 2.0 new.xlsx');
...
console.log(`Updated ${updatedCount} existing HSK 1 (2.0) items, added ${newCount} new items.`);

// Re-assemble database: non-HSK1 2.0 items + updated HSK 1 2.0 items
